...
public class XxGetNotificationsItem extends Entity {

    private String fromUser;
    private String notifDate;
    private String subject;
    private String userKey;
    private BigDecimal notifCt;
    ...
    public BigDecimal getNotifCt() {
        return this.notifCt;
    }

    public void setNotifCt(BigDecimal notifCt) {
        this.notifCt = notifCt;
    }
